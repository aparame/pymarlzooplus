...
For environments that support saving trajectory data (e.g. `episode_runner.py` with `save_data=True`), you can visualize the saved JSON trajectories using the included replay script.

```sh
python replay_trajectory.py <path_to_json_file>
```
**Controls:**
- **Space**: Pause/Resume
